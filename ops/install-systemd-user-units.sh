...
install -m 644 "$script_dir/backup/backup_sqlite.py" "$ops_root/backup_sqlite.py"
install -m 644 "$script_dir/backup/backup_private_root.py" "$ops_root/backup_private_root.py"
install -m 644 "$script_dir/../backend/src/autonomo_taxes/backup_settings.py" "$ops_root/backup_settings.py"
install -m 644 "$script_dir/backup/restore_private_root.py" "$ops_root/restore_private_root.py"
