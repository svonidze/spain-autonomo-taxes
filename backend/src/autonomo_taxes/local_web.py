...
def _source_import_root() -> Path | None:
    """Use the imported source package; installed wheels never need a source path."""
...
def _default_project_root() -> Path:
    ...
    if project.name == "backend" and (project.parent / "frontend/package.json").is_file():
