...
class UiAssets:
    def __init__(self, source_root: Path, *, allow_test: bool = False) -> None:
        ...
        try:
            ...
            raise RuntimeError("Frontend build is missing or invalid. Run npm --prefix frontend ci --include=dev and npm --prefix frontend run build from the repository root before installing or starting the web application.") from exc
