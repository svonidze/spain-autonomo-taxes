// Existing numerical and SVG geometry, retained unchanged during the Vue cutover.
...
export {buildCartesianScene, buildHorizontalBarsScene, buildBulletScene, mountScene, renderCartesian, renderHorizontalBars, renderBullet};
